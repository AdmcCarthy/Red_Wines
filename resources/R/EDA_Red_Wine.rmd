...
The plot is double encoded for each quality category with both a colour
and a different symbol, this helps emphasize the rarer values of 3, 4, 7 and
...
The last plot uses a bubble chart separated by each factor of quality. The
...
The ratio of fixed acidity to citric acid 
controls the size but shows no immediate patterns within this
